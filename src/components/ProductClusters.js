...
export default class ProductClusters extends React.Component {
    ...
    filter_clusters = () => {
        ...
        this.setState({filters: new_filters, page:0}, () => {
            this.load_clusters()
            this.fetch_product_clusters_pagination_info()
        });
    }
    ...
    render() {
        return (
            <div className="row" style={{height:"100%"}}>
                ...
                <div className="col-3 border rounded d-flex flex-column mb-3 bg-white" style={{height:"89vh"}}>
                    <div>
                        <div className="row">
                            <h2 className="m-3 ms-1 col-8">Filters</h2>
                            <span className="col-3 pt-3 pe-0">
                                <button className="btn btn-danger col-12 rounded-pill" id="reset-filters-btn" onClick={this.reset_filters}>Reset</button>
                            </span>
                        ...
                        <button className="col-12 mb-3 btn btn-success rounded-pill" id="filter-btn" onClick={this.filter_clusters}>Filter
                        </button>
                    </div>
                    {this.state.paginationInfo.numberOfResults > 0  && <div className="mt-auto text-center">
                        ...
                        <div className="row justify-content-center">
                            <button className="col-5 m-2 btn btn-primary rounded-pill" id="previous-page"
                                    onClick={this.load_previous_page}>Previous
                            </button>
                            <button className="col-5 m-2 btn btn-primary rounded-pill" id="next-page"
